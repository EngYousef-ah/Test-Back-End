...
<body>
    ...
    <div class="landing">
        <div class="container">
            <div class="text">
                ...
                <p class="two">Lorem ipsum dolor sit.</p>
                <a href="signup.php">sign up</a>
            </div>
            <img src="images/Ecommerce web page-rafiki.png" alt="">
        </div>
    </div>

    <!-- Start Services-->
    <div class="container-fluid pt-3 bg-white mt-5">
        <div class="row px-xl-5 pb-3 text-dark">
            <div class="col-lg-3 col-md-6 com-sm-12 pb-1 pt-3 ">
                <div class="d-flex align-items-center border mb-4" style="padding: 30px">
                    ...
                    <h4 class="m-0  fst-italic text-dark " style="font-size: 23px;">Quality Product
                    </h4>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 com-sm-12 pb-1 pt-3">
                <div class="d-flex align-items-center border mb-4" style="padding: 30px">
                    ...
                    <h4 class=" m-0  fst-italic text-dark" style="font-size: 23px;">Free Shipping </h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 com-sm-12 pb-1 pt-3">
                <div class="d-flex align-items-center border mb-4" style="padding: 30px">
                    ...
                    <h4 class=" m-0  fst-italic text-dark" style="font-size: 23px;">14-Day Return</h4>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 com-sm-12 pb-1 pt-3">
                <div class="d-flex align-items-center border mb-4" style="padding: 30px">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor"
                        class="bi bi-telephone-inbound-fill" viewBox="1 0 16 16">
                        <path fill-rule="evenodd"
                            d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.68.68 0 0 0 .178.643l2.457 2.457a.68.68 0 0 0 .644.178l2.189-.547a1.75 1.75 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.6 18.6 0 0 1-7.01-4.42 18.6 18.6 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877zM15.854.146a.5.5 0 0 1 0 .708L11.707 5H14.5a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5v-4a.5.5 0 0 1 1 0v2.793L15.146.146a.5.5 0 0 1 .708 0" />
                    </svg>
                    <h4 class=" m-0  fst-italic text-dark" style="font-size: 23px;">24/7 Support</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container py-5">
        <h1 class="text-center" id="Categories" style="color: var(--main-color);">Our Products</h1>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="mb-5 d-flex justify-content-around">
                        ...
                        <a href="cartinsert.php?name=<?php echo $product['name']?> &
    ...
    <!--Start Footer-->
    <footer class="text-center text-lg-start text-white bg-dark" id="footer">
            ...
            <div class="container text-center text-md-start mt-5">
                <div class="row mt-3">
                    ...
                    <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                        ...
                        <hr class="mb-4 mt-0 d-inline-block mx-auto" />
                        <p>
                            <a href="#" class="text-white">Codeforces</a>
                        </p>
                        <p>
        ...
        <div class="text-center p-3" style="backgroundColor : rgba(0, 0, 0, 0.2)">
            © 2024 Copyright:
            <a class="text-white" href="index.html">Apple-Store.com</a>
        </div>
    </footer>
